# ChatBot 0.22 - Atualização
# O tamanho da janela de saída foi ajustado, as sub-opções foram editadas e o campo de resposta foi criado.
...
def exibir_resposta(opcao, respostas):
    exibir_mensagem_chatbot(respostas.get(opcao, "Opção não reconhecida."))
...
respostas_principal = {
    "Consultar CPF": "A consulta do CPF pode ser feita no site da Receita Federal.",
    "Consultar FGTS": "Para consultar o FGTS, acesse o site da Caixa Econômica.",
